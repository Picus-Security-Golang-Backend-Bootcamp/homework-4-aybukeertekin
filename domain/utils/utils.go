...
var ErrBookIsAlreadyDeleted = errors.New("Book is already deleted!")
var ErrStockIsNotEnough = errors.New("Requested number of books is not available in the stock!")
var ErrPageCountIsNotNumber = errors.New("The book named %s's page count is not number!")
var ErrPriceIsNotNumber = errors.New("The book named %s's price is not number!")
var ErrStockCountIsNotNumber = errors.New("The book named %s's stock count is not number!")
